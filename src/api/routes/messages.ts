...
// default "claude-*" small/fast model). Override with KIMI_MESSAGES_MODEL.
const DEFAULT_MODEL = process.env.KIMI_MESSAGES_MODEL || 'kimi';
...
export default {
    ...
    post: {
        ...
        '/messages': async (request: Request) => {
            ...
            if (KIMI_AUTHORIZATION) auth = 'Bearer ' + KIMI_AUTHORIZATION;
